...
/**
 * Register Page (TanStack Query)
 * 
 * BFF Pattern: Tokens handled server-side.
...
useSeoMeta({
    title: 'Criar Conta | Gabarita.ai',
    description: 'Crie sua conta gratuita no Gabarita.ai',
})
...
// Validation schema (OWASP compliant)
...
<template>
    <div class="min-h-screen bg-zinc-950 flex items-center justify-center p-4 py-12">
        <!-- Background gradient -->
        ...
        <div class="relative w-full max-w-md">
            ...
            <div class="bg-zinc-900/80 backdrop-blur-xl rounded-2xl border border-zinc-800 p-8 shadow-2xl">
                <div class="text-center mb-8">
                    ...
                    <p class="text-zinc-400">Comece a estudar de forma inteligente</p>
                </div>
                    ...
                    <UCheckbox v-model="form.acceptTerms">
                        <template #label>
                            <span class="text-sm text-zinc-400">
                                Li e aceito os
                                <NuxtLink to="/terms" class="text-violet-400 hover:text-violet-300">Termos de Uso
                                </NuxtLink>
                                e a
